...
async function register() {
  ...
  // !! ATTENZIONE !! questi controlli devono essere fatti anche lato backend, perché un utente malintenzionato potrebbe bypassare quelli frontend inviando richieste direttamente al backend (es. con Postman)
